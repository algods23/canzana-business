...
@section('title', 'Edit Tilapia Sales')
@section('page-title', 'Edit Tilapia Sales')
...
@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.tilapia.sales.update', $transaction) }}" class="space-y-6">
            @csrf
            @method('PUT')
