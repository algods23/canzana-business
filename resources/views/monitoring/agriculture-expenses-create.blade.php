...
@section('title', 'Add Agriculture Expenses')
@section('page-title', 'Add Agriculture Expenses')
...
@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.agriculture.expenses.store') }}" class="space-y-6">
            @csrf
