...
@section('title', 'Edit Conel Deposit')
@section('page-title', 'Edit Conel Deposit')
...
@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.conel.deposit.update', $transaction) }}" class="space-y-6">
            @csrf
            @method('PUT')
