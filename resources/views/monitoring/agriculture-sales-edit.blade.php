...
@section('title', 'Edit Agriculture Sales')
@section('page-title', 'Edit Agriculture Sales')
...
@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.agriculture.sales.update', $transaction) }}" class="space-y-6">
            @csrf
            @method('PUT')
