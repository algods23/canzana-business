...
@section('title', 'Edit 128 Withdrawal')
@section('page-title', 'Edit 128 Withdrawal')
...
@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.128.withdraw.update', $transaction) }}" class="space-y-6">
            @csrf
            @method('PUT')
