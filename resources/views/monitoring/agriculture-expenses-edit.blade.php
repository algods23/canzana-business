...
@section('title', 'Edit Agriculture Expenses')
@section('page-title', 'Edit Agriculture Expenses')

@section('header-actions')
    <a href="{{ route('monitoring.agriculture') }}" class="btn btn-secondary">Cancel</a>
@endsection

@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.agriculture.expenses.update', $transaction) }}" class="space-y-6">
            @csrf
            @method('PUT')
