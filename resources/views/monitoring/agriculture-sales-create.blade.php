...
@section('title', 'Add Agriculture Sales')
@section('page-title', 'Add Agriculture Sales')
...
@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.agriculture.sales.store') }}" class="space-y-6">
            @csrf
