...
@section('title', 'Add Conel Withdrawal')
@section('page-title', 'Add Conel Withdrawal')
...
@section('content')
    <div class="panel p-6">
        <form method="POST" action="{{ route('monitoring.conel.withdraw.store') }}" class="space-y-6">
            @csrf
